...
public class AlarmReceiver extends BroadcastReceiver {
    public static void startAlarm(Activity act, String name, String title, String label, int secondsFromNow){
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Class<?> cc = null;
        try {
          cc = context.getClassLoader().loadClass("com.labor.test2.FullscreenActivity");
