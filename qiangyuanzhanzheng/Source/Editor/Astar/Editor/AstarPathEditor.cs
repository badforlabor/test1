...
public class AstarPathEditor : Editor {
    ...
    public static string editorAssets = "Assets/Editor/EditorAssets";
...
#region Styles
	...
	public void DrawMainArea () {
		...
		EditorGUILayoutx.FadeArea graphsFadeArea = GUILayoutx.BeginFadeArea (script.showGraphs,"Graphs1", "showGraphInspectors", EditorGUILayoutx.defaultAreaStyle, topBoxHeaderStyle);
